-- Advanced LazyVim Setup with Full Integrations
  ...
  -- Lualine integration
  {
    ...
    opts = function(_, opts)
      local function todo_status()
        ...
        local color = stats.completion_rate == 100 and "green" or 
                      stats.active > 5 and "red" or "yellow"
